    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="py-4" action=" {{ url('update-student/'.$student->id) }} " method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="ncin" class="form-label">Ncin :</label>
                        <input type="text" class="form-control" id="ncin" name="ncin" placeholder="Enter your cin" value="{{ $student->ncin }}">
                        @error('ncin')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="mail" class="form-control" id="email" name="email" placeholder="Enter your email" value="{{ $student->email }}">
                        @error('email')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter your phone number" value="{{ $student->phone }}">
                        @error('phone')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
